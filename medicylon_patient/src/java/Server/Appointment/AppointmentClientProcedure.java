...
//    
    ...
    public Response loadReport(AppointmentModel appointmentModel) {
        Client client = ClientBuilder.newClient(new ClientConfig());
        WebTarget webTarget = client.target(getURI()).path("business/appointment/loadreport");
        Invocation.Builder builder = webTarget.request(MediaType.APPLICATION_JSON);
        Response response = builder.post(Entity.entity(appointmentModel, MediaType.APPLICATION_JSON));
        return response;
    }
    ...
    public static void main(String[] args) {
        ...
        Response r = new AppointmentClientProcedure().loadReport(model);
        AppointmentModel a = r.readEntity(AppointmentModel.class);
