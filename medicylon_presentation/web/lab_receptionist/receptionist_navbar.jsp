<%-- 
    Document   : RecepNavBar
    Created on : Oct 17, 2020, 12:19:37 PM
    Author     : divsi
--%>
...
<!--    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>-->
    ...
    <body style="background-color:#F8F9F9;">
        ...
        if (job != null) {
        if(!job.equalsIgnoreCase("receptionist")){
            session.invalidate();
        ...
        <nav class="w3-sidebar w3-bar-block w3-collapse w3-animate-left w3-card" style="z-index:3;width:200px;" id="mySidebar">
           <h5 class="w3-padding-64 w3-center w3-black">Welcome,<b> <br><%= name %></b></h5>
            ...
            <a style="text-decoration: none" class="w3-bar-item w3-button ${param.dashboard}" href="receptionist_dashboard.jsp"><i class="fa fa-home" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Dashboard</a>
            <a style="text-decoration: none" class="w3-bar-item w3-button ${param.patient}" href="receptionist_patient.jsp"><i class="fa fa-male" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Patient</a>
            <a style="text-decoration: none" class="w3-bar-item w3-button ${param.appointment}" href="receptionist_appointment.jsp"><i class="fa fa-calendar" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Appointment</a>
            ...
            <!--<a class="w3-bar-item w3-button" href="#">Tests</a>-->
        </nav>
...
//            validation
            ...
            var btnContainer = document.getElementById("mySidebar");
...
for (var i = 0; i < btns.length; i++) {
  btns[i].addEventListener("click", function() {
    var current = document.getElementsByClassName("w3-ios-blue");
    current[0].className = current[0].className.replace(" w3-ios-blue", "");
    this.className += " w3-ios-blue";
  });
}
        </script>
    </body>
